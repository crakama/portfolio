...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Main', fields ['email', 'ref_id']
        db.create_unique(u'mainapp_main', ['email', 'ref_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Main', fields ['email', 'ref_id']
        db.delete_unique(u'mainapp_main', ['email', 'ref_id'])
