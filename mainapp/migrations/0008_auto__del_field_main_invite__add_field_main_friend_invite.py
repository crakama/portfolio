...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Main.invite'
        db.delete_column(u'mainapp_main', 'invite_id')
    ...
    def backwards(self, orm):
        # Adding field 'Main.invite'
        db.add_column(u'mainapp_main', 'invite',
    ...
    models = {
        u'mainapp.main': {
            ...
            'friend_invite': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'referral'", 'null': 'True', 'to': u"orm['mainapp.Main']"}),
